...
namespace base64Codec  {
	...
	void decodeByteBlock(const uint8_t * block, size_t len, std::shared_ptr<uint8_t[]>& OUT_outputVal, size_t out_len, bool recountBase = false); //Wants a previously allocated and nulled array as outputVal
